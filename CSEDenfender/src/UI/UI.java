...
public class UI {
	...
	public class Menu
	{
		...
		private int x, y, width, height, buttonAmout, optionsWidth, optionsHeight, padding;
		...
		private void setButton(Button b){
			if(optionsWidth != 0)
			{
				b.setY(y + (buttonAmout / optionsWidth) * TILE_SIZE);
			}
			b.setX(x + (buttonAmout % 2)* (padding + TILE_SIZE) + padding);
			buttonAmout++;
			menuButtons.add(b);
